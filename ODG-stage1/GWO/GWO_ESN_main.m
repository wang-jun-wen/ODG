...
% %%  GWO Optimization
[~, Best_pos, curve]=GWO(pop, Max_iteration, lb,ub,dim,data_group);
%% Save Results
%save('C:\Users\wangjunwen\Desktop\curve\GWO_curve.mat', 'curve');
%save('C:\Users\wangjunwen\Desktop\Best_pos\GWO_pos.mat', 'Best_pos');
%% End Time 
