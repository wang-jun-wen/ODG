...
%%  SOGWO Optimization
[~, Best_pos, curve]=SOGWO(pop, Max_iteration, lb,ub,dim,data_group);
%% Save Results
%save('C:\Users\wangjunwen\Desktop\curve\SOGWO_curve.mat', 'curve');
%save('C:\Users\wangjunwen\Desktop\Best_pos\SOGWO_pos.mat', 'Best_pos');
%% End Time 
