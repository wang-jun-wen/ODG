...
function [Alpha_score,Alpha_pos,Convergence_curve]=SOGWO(SearchAgents_no,Max_iter,lb,ub,dim,data_group)
...
while l<Max_iter
    for i=1:size(Positions,1)
        ...
        fitness(i)=getfitness_average(Positions(i, :),data_group);
    ...
    disp(['第',num2str(l),'次迭代'])
    disp(['current iteration is: ',num2str(l), ', best fitness is: ', num2str(Alpha_score)]);
    format long
    disp(Alpha_pos);
end
end
