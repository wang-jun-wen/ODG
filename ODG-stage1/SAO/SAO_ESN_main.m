...
%%  SAO Optimization
[Best_pos, ~, curve]=SAO(pop, Max_iteration, lb,ub,dim,data_group);
%% Save Results
%save('C:\Users\wangjunwen\Desktop\curve\SAO_curve.mat', 'curve');
%save('C:\Users\wangjunwen\Desktop\Best_pos\SAO_pos.mat', 'Best_pos');
%% End Time 
